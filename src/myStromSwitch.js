module.exports = function(RED) {
  function myStromSwitch(config) {
    ...
    this.on("input", function(msg) {
      ...
      if (!requests.isValid(taskJSON, this.DEVICE_TYPE)) {
        taskJSON = { "ip": this.device.host, "mac": this.device.mac, "request": config.request }
  ...
  RED.nodes.registerType("myStrom Switch", myStromSwitch);
